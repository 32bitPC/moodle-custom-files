...
function cohort_student_get_all_phl_cohorts($page = 0, $perpage = 250, $search = '') {
    ...
    $fields = "SELECT c.*,ch.ngayhoc,ch.ngaythi,ch.giothi,qh.khuvuc,ch.thangnam,ch.khoahoc,mi.tenmien,kv.tenkhuvuc,co.fullname,qh.tenquanhuyen,CONCAT('ThÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡ng -',MID(thangnam,5,2),' - NÃƒÆ’Ã¢â‚¬Å¾Ãƒâ€ Ã¢â‚¬â„¢m ',MID(thangnam,1,4)) as mieutathangnam";
