    ...
    public function phl_load_csv_content($content, $encoding, $delimiter_name, $column_validation=null, $enclosure='"') {
        ...
        if (!isset($columns[0])) {
            ...
            for($i=4;$i<=$count_members+3;$i++){
                ...
                if(empty($columns[$i][15])){
                    $columns[$i][15] = '';
                }
                if(empty($columns[$i][16])){
                    $columns[$i][16] = '';
                }
                if(empty($columns[$i][19])){
                    $columns[$i][19] = '';
                }
                $name = $columns[$i][1];
                $username = $columns[$i][5];
                $array_username_sql = "
        select id from mdl232x0_user where firstname + ' '  + lastname = N'$name'
        and username = N'$username'
";
...
<p><span class='bubble'>Báº£ng Ä‘iá»ƒm danh Ä‘Ã£ Ä‘Æ°á»£c thÃªm vÃ o há»‡ thá»‘ng, Ä‘á»ƒ cáº­p nháº­t báº£ng Ä‘iá»ƒm danh, báº¥m Back Ä‘á»ƒ quay láº¡i báº¯t Ä‘áº§u upload báº£ng Ä‘iá»ƒm danh má»›i</span>&nbsp;&nbsp;&nbsp;&#128513</p>
";
...
";
            echo "<table>
  <tr>
    <th style='color:white;'>TÃªn há»c viÃªn</th>
<th style='color:white;'>NgÃ y/ThÃ¡ng/NÄƒm sinh</th>
<th style='color:white;'>CMTND</th>
<th style='color:white;'>Buá»•i 1</th>
<th style='color:white;'>Buá»•i 2</th>
<th style='color:white;'>Buá»•i 3</th>
<th style='color:white;'>Buá»•i 4</th>
<th style='color:white;'>Buá»•i 5</th>
<th style='color:white;'>Buá»•i 6</th>
<th style='color:white;'>Äiá»u kiá»‡n tham dá»±</th>
  </tr>
  ";
            for($i=4;$i<=$count_members+3;$i++){
            ...
            echo "<td>".$columns[$i][15]."</td>";
            echo "<td>".$columns[$i][16]."</td>";
            echo "<td>".$columns[$i][19]."</td></tr>";
            }
...
#mform1{ display : none;}
            ...
            echo "<form style='display:inline-block; width:45%;text-align:center;' action='upload_diemdanh.php'><button class='button button1'>Back</button></form>";
